...
// React 18 needs forwardRef for refs to flow through function components.
// Without it, `<DropdownMenuTrigger asChild><SidebarMenuButton/>` silently
// drops the trigger ref and the dropdown never opens.
